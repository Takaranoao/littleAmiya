package com.takaranoao.littleamiya.client.model;
...
public class ModelAmiya extends ModelBase {
    ...
    public ModelAmiya() {
        ...
        this.muleLeftEar.addBox(-2.0F, -18.0F, 4.0F, 2, 10, 1);
        ...
        this.muleRightEar.addBox(0.0F, -18.0F, 4.0F, 2, 10, 1);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        EntityRabbit abstracthorse = (EntityRabbit) entityIn;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityRabbit abstracthorse = (EntityRabbit) entitylivingbaseIn;
        float f5 = 0.2F;//abstracthorse.getGrassEatingAmount(partialTickTime);
        float f6 = 0.0F;//abstracthorse.getRearingAmount(partialTickTime);
        float f7 = 1.0F - f6;
        float f8 = 0.0F;//abstracthorse.getMouthOpennessAngle(partialTickTime);
